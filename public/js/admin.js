...
var removeBtn = Array.from(document.querySelectorAll(".removeBtn"));
var reportAction = Array.from(document.querySelectorAll(".selectAction"));
var toast = document.getElementById("myToast");
var msgElem = document.querySelector(".toast-body");

// function show toast

var showAlert = function showAlert(Toastmsg) {
...
if (removeBtn) {
  removeBtn.forEach(function (btn) {
    ...
    btn.addEventListener("click", function () {
      axios__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"](url).then(function (res) {
...
if (reportAction) {
  reportAction.forEach(function (action) {
    var reportId = action.getAttribute("data-reportId");
    var url = " ";
    action.addEventListener("change", function () {
      ...
      if (selectedAction == "Delete") {
        url = "/admin/handleReport/".concat(reportId, "?action=Delete");
      } else {
        url = "/admin/handleReport/".concat(reportId, "?action=Discard");
      }
      axios__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"](url).then(function (res) {
